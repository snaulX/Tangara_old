...
extern "C" TgObj* tg_Tangara_Entry_ctor0(TgObj* params[])
{
	...
	return TgPtr((void*) new Tangara::Entry(arg_name), TgGetTypeHash("Tangara.Entry"));
}
...
extern "C" TgObj* tg_Tangara_Entry_GetClass(void* obj, TgObj* params[])
{
	...
	char* arg_name = static_cast<char*>(malloc(params[0]->size));
	memcpy(arg_name, params[0]->data, params[0]->size);
	TgObj* tgObj = TgPtr((void* )cppObj->GetClass(arg_name), TgGetTypeHash("Tangara::Class*"));
	return tgObj;
}
extern "C" TgObj* tg_Tangara_Entry_GetName(void* obj, TgObj* params[])
{
	auto* cppObj = static_cast<Tangara::Entry*>(obj);
	TgObj* tgObj = TgPtr((void* const)cppObj->GetName(), TgGetTypeHash("const char*"));
	return tgObj;
}
extern "C" TgObj* tg_Tangara_Entry_GetHashCode(void* obj, TgObj* params[])
{
	...
	*resultPtr = result;
	TgObj* tgObj = TgPtr((void* )resultPtr, TgGetTypeHash("uint32_t"));
	return tgObj;
}
extern "C" TgObj* tg_Tangara_Class_ctor0(TgObj* params[])
{
	char* arg_name = static_cast<char*>(malloc(params[0]->size));
	memcpy(arg_name, params[0]->data, params[0]->size);
	return TgPtr((void*) new Tangara::Class(arg_name), TgGetTypeHash("Tangara.Class"));
}
extern "C" TgObj* tg_Tangara_Class_New(void* obj, TgObj* params[])
{
	...
	TgObj* tgObj = TgPtr((void* )cppObj->New(arg_params), TgGetTypeHash("TgObj*"));
	return tgObj;
}
extern "C" TgObj* tg_Tangara_Class_Run(void* obj, TgObj* params[])
{
	...
	TgObj* tgObj = TgPtr((void* )cppObj->Run(arg_self, arg_methodName, arg_params), TgGetTypeHash("TgObj*"));
	return tgObj;
}
...
extern "C" TANGARA_API void* tgLoadEntry() 
{
	...
	Tangara_Entry_ctor0_paramTypes.types[0] = TgGetTypeHash("char*");
	...
	Tangara_Entry_AddClass_paramTypes.types[0] = TgGetTypeHash("Tangara.Class*");
	Tangara_Entry_AddClass_paramTypes.names[0] = "cl";
	Tangara_Entry_class->CreateMethod("AddClass", tg_Tangara_Entry_AddClass, TgGetType("void"), Tangara_Entry_AddClass_paramTypes);
	...
	Tangara_Entry_LinkEntry_paramTypes.types[0] = TgGetTypeHash("Tangara.Entry*");
	Tangara_Entry_LinkEntry_paramTypes.names[0] = "e";
	Tangara_Entry_class->CreateMethod("LinkEntry", tg_Tangara_Entry_LinkEntry, TgGetType("void"), Tangara_Entry_LinkEntry_paramTypes);
	...
	Tangara_Entry_GetClass_paramTypes.types[0] = TgGetTypeHash("char*");
	Tangara_Entry_GetClass_paramTypes.names[0] = "name";
	Tangara_Entry_class->CreateMethod("GetClass", tg_Tangara_Entry_GetClass, TgGetType("Tangara::Class*"), Tangara_Entry_GetClass_paramTypes);
	...
	Tangara_Entry_class->CreateMethod("GetName", tg_Tangara_Entry_GetName, TgGetType("const char*"), Tangara_Entry_GetName_paramTypes);
	...
	Tangara_Entry_class->CreateMethod("GetHashCode", tg_Tangara_Entry_GetHashCode, TgGetType("uint32_t"), Tangara_Entry_GetHashCode_paramTypes);
	Tangara_entry->AddType(Tangara_Entry_class);
	...
	Tangara_Class_ctor0_paramTypes.types[0] = TgGetTypeHash("char*");
	...
	Tangara_Class_New_paramTypes.types[0] = TgGetTypeHash("TgParams");
	Tangara_Class_New_paramTypes.names[0] = "params";
	Tangara_Class_class->CreateMethod("New", tg_Tangara_Class_New, TgGetType("TgObj*"), Tangara_Class_New_paramTypes);
	...
	Tangara_Class_Run_paramTypes.types[0] = TgGetTypeHash("TgObj*");
	Tangara_Class_Run_paramTypes.names[0] = "self";
	Tangara_Class_Run_paramTypes.types[1] = TgGetTypeHash("char*");
	Tangara_Class_Run_paramTypes.names[1] = "methodName";
	Tangara_Class_Run_paramTypes.types[2] = TgGetTypeHash("TgParams");
	Tangara_Class_Run_paramTypes.names[2] = "params";
	Tangara_Class_class->CreateMethod("Run", tg_Tangara_Class_Run, TgGetType("TgObj*"), Tangara_Class_Run_paramTypes);
	Tangara_entry->AddType(Tangara_Class_class);
